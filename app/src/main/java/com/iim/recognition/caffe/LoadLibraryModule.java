...
public class LoadLibraryModule {
    ...
    public native boolean recognition_start(String model_path, int use_spoofing);
    ...
    public native void save_spoofingimage(byte[] image_data, int[] face_region,
                                          int width, int height, int is_rgb, int is_real);
    public native int run_spoofing(byte[] image_data, int[] face_region,
